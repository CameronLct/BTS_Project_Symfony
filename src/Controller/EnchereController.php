...
class EnchereController extends AbstractController
{
    ...
    public function index(EnchereRepository $enchereRepo): Response
    {
        ...
        $res  = $client->request(method: 'GET', url: 'https://localhost:44355/Fournisseurs/AllFournisseurs');
        ...
        $res2 = $client->request(method: 'GET', url: 'https://localhost:44355/Panier_Global/AllPanierGlobal');
        ...
        $res4 = $client->request(method: 'GET', url: 'https://localhost:44355/Panier_Global_Details/GetGlobalDetailByPanier?ID='.$dernierPanierGlobal['id'].''); //appel a l'api
        $panierglobaldetail = $res4->toArray();


        $res5 = $client->request(method: 'GET', url: 'https://localhost:44355/Reference/AllReference'); //appel a l'api
        $AllReferences = $res5->toArray();

        $req6 = $client->request(method: 'GET', url: 'https://localhost:44355/Fournisseur_Reference/GetFournisseurReferenceByFournisseur?ID=1');
    ...
    public function encherir(Request $request, EntityManagerInterface $entityManager,EnchereRepository $enchereRepo) {
        ...
        $client->request( 'POST',  'https://localhost:44355/Panier_Fournisseurs',
            ['body' => [
...
////
//
//         $client->request( 'POST',  'https://localhost:44355/OffreFournisseur',
//            ['headers' => [
//                  "iD_FOURNISSEURS"=>$Id_fournisseur,
